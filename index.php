  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">PNL</div>
      </a>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="deteksiwajah.php">
          <i class="fas fa-fw fa-user-check"></i>
          <span>Deteksi Wajah</span></a>
      </li>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Mahasiswa <br>yang diajarkan</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_siswa?> (Mahasiswa)</div>
                    </div>
                    <div class="col-auto">
