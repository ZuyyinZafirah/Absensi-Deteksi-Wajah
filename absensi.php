        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card shadow mb-4">
                <!-- Card Header - Accordion -->
                <a href="#kamera" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="kamera">
                  <h6 class="m-0 font-weight-bold text-primary">Sistem Deteksi Wajah</h6>
                </a>
                <!-- Card Content - Collapse -->
                <div class="collapse hide" id="kamera">
                  <div class="card-body">
                      ...
                      <div class="container">
                        ...
                        <!-- Link untuk melihat deteksi wajah -->
                        <p>Untuk melihat deteksi wajah secara lebih rinci, klik tombol di bawah:</p>
                        <a href="deteksi_wajah.php" class="btn btn-primary">Lihat Deteksi Wajah</a>
                      </div>
                      <!-- Akhir Halaman Utama Deteksi Wajah -->
                  </div>
                </div>
              </div>
            </div>
          </div>
          <!-- Akhir Halaman Kamera -->
        </div>
        <!-- /.container-fluid -->
